...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public ReviewDTO addReview(String jwtToken, Review review, Long courseId) {
    ...
    @Override
    public ReviewDTO editReview(String jwtToken, Review newReview, Long reviewId) {
        String email = jwtProvider.extractEmailFromToken(jwtToken);
    ...
    @Override
    public void deleteReview(String jwtToken, Long reviewId) {
        String email = jwtProvider.extractEmailFromToken(jwtToken);
